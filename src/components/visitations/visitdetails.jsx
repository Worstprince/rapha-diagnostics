...
function Detail({ icon: Glyph, label, value }) {
    ...
    return (
        ...
        <div className="min-w-0 bg-rd-sunken px-6 py-5">
            ...
            >
                {value || (
                    <span className="text-rd-placeholder">
                        Not recorded
                    </span>
                )}
            </dd>
...
export default function VisitationDetails({
        ...
        try {
            ...
            if (!response.ok) {
                ...
                setToast({
                    ...
                    text:
                        result.message ||
                        "Could not load this visitation."
                });
    ...
    function getMedtechName(test) {

        if (test.medtechname) {
            return test.medtechname;
        }

        if (test.medtechid) {
            return `Medtech ID: ${test.medtechid}`;
        }
                                    ...
                                    >
                                        ...
                                        <td className={`${td} text-right`}>
                                            ...
                                            {(
                                                ...
                                                <Link
                                                    href={`${dashboardPath}/result/${test.id}`}
